<aside class="sidebar no-print" :class="{ 'open': sidebarOpen }">
    ...
    <div class="sidebar-header" style="display:flex;justify-content:space-between;align-items:center;">
        <div style="display:flex;align-items:center;gap:10px;">
            ...
            <div>
                ...
                <div style="font-size:10px;font-weight:600;color:var(--primary);text-transform:uppercase;letter-spacing:0.05em;">Klinik Hewan</div>
            </div>
        </div>
    ...
    <div style="flex:1;overflow-y:auto;padding:8px 0;">
        ...
        <div class="nav-section" style="margin-top:8px;">
            ...
            <a href="{{ route('doctor.inpatients.index') }}" class="nav-link {{ request()->routeIs('doctor.inpatients.*') ? 'active' : '' }}">
